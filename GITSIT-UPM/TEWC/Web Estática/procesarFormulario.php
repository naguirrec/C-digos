...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Correo de destino
    $destinatario = "naguirrecanidao@gmail.com"; // Cambia esto por tu dirección de correo electrónico
    ...
    if (mail($destinatario, "Nuevo mensaje de contacto", $contenido, $headers)) {
        // Redirigir a la página de respuesta si el correo se envió correctamente
        header("Location: respuesta.html");
        exit;
    } else {
        // Si hay un error al enviar el correo, redirigir a una página de error
        ...
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="active" href="procesarFormulario.php">Contact</a></li>
                </ul>
                ...
                <div class="row align-items-stretch justify-content-center no-gutters">
                    <div class="col-md-7">
                        <div class="form h-100 contact-wrap p-5">
                            ...
                            <form class="mb-5" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="contactForm" name="contactForm">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="apellidos" id="apellidos" placeholder="Tus apellidos" required>
                                    </div>
